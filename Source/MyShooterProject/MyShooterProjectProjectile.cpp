...
AMyShooterProjectProjectile::AMyShooterProjectProjectile() 
{
	...
	ProjectileMesh->OnComponentHit.AddDynamic(this, &AMyShooterProjectProjectile::OnHit);		// set up a notification for when this component hits something
